...
After extensive manual iteration the best performing model (\textbf{v9}) used the fuzzy sets in~\vref{fig:fuzzy_sets_bellv9}.
...
This model obtained an $MSE=0.0447$ on the expert dataset.
...
In \cref{fig:bandwidth_triangular_v4}, the terms and membership functions of the variable \textit{OutBandwidth} are represented.
...
\begin{figure}[H]
    \centering
\includegraphics[scale = 0.55]{../images/MSE_triangle_v4}
