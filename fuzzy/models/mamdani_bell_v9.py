...
# Latency
L1 = FuzzySet(function=Bell_MF(a=4, b=0.3, c=0), term="low")
L2 = FuzzySet(function=Bell_MF(a=4, b=0.3, c=0.5), term="medium")
L3 = FuzzySet(function=Bell_MF(a=4, b=0.2, c=1), term="high")
...
if __name__ == '__main__':
    ...
    save_path = '../output/mamdani_bell_v8'
