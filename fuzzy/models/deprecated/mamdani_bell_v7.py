...
# Memory Usage Avg [%]
M1 = TriangleFuzzySet(0, 0, 0.2, term="very_low")
M2 = FuzzySet(function=Bell_MF(a=4, b=0.1, c=0.3), term="low")
M3 = FuzzySet(function=Bell_MF(a=2, b=0.1, c=0.6), term="medium")
M4 = FuzzySet(function=Bell_MF(a=2, b=0.1, c=0.7), term="high")
...
CLP2 = FuzzySet(function=Bell_MF(a=2, b=0.15, c=-0.75), term="decrease")
#CLP3 = FuzzySet(function=Bell_MF(a=1, b=0.2, c=0.1), term="maintain")
CLP4 = FuzzySet(function=Bell_MF(a=2, b=0.15, c=0.55), term="increase")
CLP5 = TriangleFuzzySet(0.5, 1, 1, term="increase_significantly")
